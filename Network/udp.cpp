...
{
    UserDatagramProtocolSocket *socket = (UserDatagramProtocolSocket *)MemoryManager::ActiveMemoryManager->MemAllocate(sizeof(UserDatagramProtocolSocket));
...
void UserDatagramProtocolProvider::Send(UserDatagramProtocolSocket *socket, uint8_t *data, uint16_t size)
{
    ...
    uint8_t *buffer = (uint8_t *)MemoryManager::ActiveMemoryManager->MemAllocate(totalLength);

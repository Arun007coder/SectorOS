  ...
  programmableInterruptControllerSlaveDataPort(0xA1)
{
    ...
    programmableInterruptControllerMasterDataPort.WriteToPort(hardwareInterruptOffset);
    programmableInterruptControllerSlaveDataPort.WriteToPort(hardwareInterruptOffset+8);

    programmableInterruptControllerMasterDataPort.WriteToPort(0x04);
    programmableInterruptControllerSlaveDataPort.WriteToPort(0x02);

    programmableInterruptControllerMasterDataPort.WriteToPort(0x01);
    programmableInterruptControllerSlaveDataPort.WriteToPort(0x01);

    programmableInterruptControllerMasterDataPort.WriteToPort(0x00);
    programmableInterruptControllerSlaveDataPort.WriteToPort(0x00);
...
uint32_t InterruptManager::DoHandleInterrupt(uint8_t interrupt, uint32_t esp)
{
    ...
    {
        programmableInterruptControllerMasterCommandPort.WriteToPort(0x20);
        if(0x28 <= interrupt)
            programmableInterruptControllerSlaveCommandPort.WriteToPort(0x20);
    }
